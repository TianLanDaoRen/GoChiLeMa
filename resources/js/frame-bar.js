...
document.writeln("            <span class=\'icon-text has-text-light is-size-5\'>");
...
document.writeln("            <span class=\'has-text-dark is-size-6\'>");
document.writeln("                <strong id=\'window-title\'></strong>");
document.writeln("            </span>");
document.writeln("        </a>");
document.writeln("    </div>");
document.writeln("    <div class=\'navbar-menu is-active\' style=\'-webkit-app-region: drag;\'>");
